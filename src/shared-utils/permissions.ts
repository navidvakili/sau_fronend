...
export const MODULE_PERMISSIONS: Record<string, { view: string; create?: string; edit?: string; delete?: string; approve?: string }> = {
  ...
  'news-visitor-analytics': { view: 'analytics.view' },
  ...
  'announcements-visitor-analytics': { view: 'analytics.view' },
  ...
  'home-portals': { view: 'home-portals.view', edit: 'home-portals.edit' },
  'page-builder': { view: 'page-builder.view', edit: 'page-builder.edit' },
  'smart-page-visitor-analytics': { view: 'analytics.view' },
  ...
  'dedicated-page-visitor-analytics': { view: 'analytics.view' },
