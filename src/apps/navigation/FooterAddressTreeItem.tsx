          ...
          <div className="flex items-center gap-1">
            <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded-xl p-0.5">
              <button
                ...
                disabled={isFirst}
                className="p-1 hover:bg-white dark:hover:bg-slate-700 rounded-lg disabled:opacity-30"
              >
            ...
            <button
              onClick={() => onEdit(item)}
              className="p-1.5 rounded-xl bg-teal-50 dark:bg-teal-950/60 text-teal-700"
              title="ویرایش آدرس"
            >
            ...
            <button
              ...
              className="p-1.5 rounded-xl text-slate-400 hover:text-red-600"
              title="حذف"
            >
              ...
              >
                ...
                {row.isLink && row.href ? (
                  <a
                    ...
                    className="text-blue-600 dark:text-blue-400 hover:underline font-mono dir-ltr text-left"
                  >
                    {row.value}
