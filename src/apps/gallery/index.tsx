        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-72 bg-white dark:bg-slate-900 border-l border-gray-200 dark:border-slate-800 flex flex-col shrink-0 overflow-y-auto p-4 space-y-6">
            ...
            <div className="space-y-1">
              ...
              <button
                onClick={() => setFilters((f) => ({ ...f, folderId: null, fileType: 'all' }))}
                className={`w-full px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-between transition-all cursor-pointer ${
                  !filters.folderId && filters.fileType === 'all'
                    ? 'bg-teal-500/10 text-teal-600 dark:text-teal-400 font-black border border-teal-500/20'
                      ...
                      {filteredAssets.map((asset) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-3 font-mono">{asset.sizeFormatted}</td>
      ...
      <div className="relative aspect-video bg-slate-950 overflow-hidden flex items-center justify-center">
        {isImage ? (
          ...
          <div className="flex flex-col items-center justify-center gap-1.5 text-slate-300">
            ...
            <span className="text-[10px] font-mono font-bold">{asset.type}</span>
          </div>
        )}
        ...
        {/* Media Type Badge */}
        <span className="absolute bottom-3 right-3 px-2 py-0.5 rounded-md bg-black/60 backdrop-blur-md text-white font-mono text-[9px] uppercase font-bold">
          {asset.fileType}
        </span>
