      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div ref={trackAreaRef} className="flex-1 overflow-y-auto relative">
          <div className="flex relative min-h-full">
            ...
            {/* Right Tracks */}
            <div ref={tracksRef} className="flex-1 relative bg-white dark:bg-slate-950">
              {/* Time Scrubber Red Cursor Line — positioned relative to the tracks
                  area (labels column excluded) so it starts at the 0s tick and
                  stays aligned with the ruler and the layer bars */}
              <div
              ...
              {slide.layers.map(layer => {
                ...
                const widthPercent = getPercent(windowDur);
                const inPercent = getPercent(inDuration);
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{ width: `${widthPercent > 0 ? Math.max(0, (1 - inPercent / widthPercent) * 100) : 0}%` }}
                      />
